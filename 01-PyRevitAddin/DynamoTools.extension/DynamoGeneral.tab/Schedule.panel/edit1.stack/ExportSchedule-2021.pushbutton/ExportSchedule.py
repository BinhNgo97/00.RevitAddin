...
class MyWindow(Window): 
    def __init__(self):
        ...
        self.winLoad = wpf.LoadComponent(self, r"G:\My Drive\CV-STRUCTON\01-Dynamo\DynamoTools.extension\DynamoGeneral.tab\Schedule.panel\edit1.stack\ExportSchedule-2021.pushbutton\UI-ExportSchedule.xaml")
